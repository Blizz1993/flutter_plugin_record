...
class FlutterPluginRecordPlugin: MethodCallHandler ,PluginRegistry.RequestPermissionsResultListener{
  ...
  //val myList = mutableListOf<RecorderUtil>()
  val recorderList = mutableListOf<RecorderUtil>()
  companion object {
    @JvmStatic
  ...
  private fun stopPlay(){
    for(recorderUtil in recorderList){
      recorderUtil.stopVoice()
    }
  }
